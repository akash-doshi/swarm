...
def generate_n_colors(n, cmap_name='tab20b'):
    """
...
def colors_for_voronoi_polys_and_points(poly_shapes, poly_to_pt_assignments, cmap_name='tab20b'):
    """
...
def plot_voronoi_polys(ax, poly_shapes, color=None, edgecolor=None, labels=None, label_fontsize=10, label_color=None,
    ...
    _plot_polygon_collection_with_color(ax, poly_shapes, edgecolor="black", color=color ) #, edgecolor=edgecolor)
...
def plot_points(ax, points, markersize, marker='o', color=None, labels=None, label_fontsize=7, label_color=None,
    ...
    ax.scatter(coords[:, 0], coords[:, 1], s=markersize, marker=marker, color='black', **kwargs)
...
def plot_voronoi_polys_with_points_in_area(ax, area_shape, poly_shapes, points, poly_to_pt_assignments=None,
                                           ...
                                           voronoi_and_points_cmap='tab20b',
...
def _plot_polygon_collection_with_color(ax, geoms, color=None, **kwargs):
    ...
    **kwargs
    ...
    if isinstance(color, (list, tuple)):
        geoms, color = _flatten_multi_geoms(geoms, (np.random.rand(3,) for poly in geoms))
    else:
